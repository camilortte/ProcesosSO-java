...
public class VentanaPrincipal extends javax.swing.JFrame {
                    ...
                    .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel6Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(jTextField_nombre, javax.swing.GroupLayout.DEFAULT_SIZE, 267, Short.MAX_VALUE)
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel8Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtTimeListo, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(txtTimeBloqueados, javax.swing.GroupLayout.DEFAULT_SIZE, 57, Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(jLabel_MicrofonoDis, javax.swing.GroupLayout.PREFERRED_SIZE, 65, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void botonMatarProcesoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonMatarProcesoActionPerformed
        ...
        if ("".equals(txtIdProceso.getText()) || "".equals(txtNombreProceso.getText()) || "".equals(txtEstadoProceso.getText()) || "".equals(txtTamanhoProceso.getText())) {
            ...
            if (liberar.length > 0) {
                for (int i = 0; i < liberar.length; i++) {
                    if (liberar[i].getNombre().compareTo(dispositivosDisponibles[i].getNombre()) == 0) {
        ...
        switch (jComboBox_dispositivos.getSelectedIndex()) {
            case 0:
                ...
                if (dispositivos != null) {
                    ...
                    if (!"".equals(jLabel_infoContenedorDis.getText())) {
    ...
    public void actualizarInformacion(int filaSelected) {
        ...
        if (jTable1.getSelectedRow() >= 0) {
            txtTamActual.setText("" + jTable1.getValueAt(jTable1.getSelectedRow(), 2));
            txtEstadoProceso.setText("" + jTable1.getValueAt(jTable1.getSelectedRow(), 3));
        }
        //}
        // }).start();
    }
